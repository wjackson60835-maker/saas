...
$nowtime=time();
$xglhc = "select actionNo,lhcTime from ay_kjdata_time where type = 1 and lhcTime > '$nowtime'";
...
$kaijiangshuju="select * from ay_kjdata where type = 1 and time < '$nowtime' order by number desc limit 1";
