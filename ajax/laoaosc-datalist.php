...
function GetBoseName2($number,$type){
	$arr['ballred']='01,02,07,08,12,13,18,19,23,24,29,30,34,35,40,45,46';
	$arr['ballgreen']='03,04,09,10,14,15,20,25,26,31,36,37,41,42,47,48';
	$arr['ballblue']='05,06,11,16,17,21,22,27,28,32,33,38,39,43,44,49';
...
$kaijiangshuju="select * from ay_lakjdata where time < '$nowtime' and type = 1 order by number desc limit 40";
