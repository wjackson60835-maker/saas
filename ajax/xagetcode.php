...
$nowtime = time();
$lhcTime = lhc_fetch_next_draw_row($pdo, 'ay_xakjdata_time', 1, $nowtime);
...
if ($predrawLock) {
	...
	$kaijiangshuju = "select * from ay_xakjdata where type = 1 and time < '$nowtime' order by number desc limit 1";
...
$currentTime = time();
$targetTime111 = strtotime('21:25:00');
$targetTime222 = strtotime('21:35:00');
if (!$predrawLock && $currentTime > $targetTime111 && $currentTime < $targetTime222) {
	$haoma1 = "稍";
	$haoma2 = "后";
	$haoma3 = "马";
	$haoma4 = "上";
	...
	$haoma7 = "啦";
	$haomama = "01";
	$ys1 = GetBoseName2($haomama, 1);
	$ys2 = GetBoseName2($haomama, 1);
	$ys3 = GetBoseName2($haomama, 1);
	$ys4 = GetBoseName2($haomama, 1);
	$ys5 = GetBoseName2($haomama, 1);
	$ys6 = GetBoseName2($haomama, 1);
	$ys7 = GetBoseName2($haomama, 1);
	$shengxiao1 = "";
	$shengxiao2 = "";
	$shengxiao3 = "";
	$shengxiao4 = "";
